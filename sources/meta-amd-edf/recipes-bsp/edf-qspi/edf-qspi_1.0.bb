...
DESCRIPTION = "QSPI image with image selector, image recovery, update metadata and boot.bin"
LICENSE = "MIT"
...
SPI_BOOTBIN_OFFSET          ?= "0x15C_0000 0x260_0000"
SPI_USER_SCRATCH_OFFSET     ?= "0x364_0000"
SPI_MANIFEST_OFFSET         ?= "0x3FF_0000"
...
# QSPI manifest (last sector, 64KB erase sector size)
